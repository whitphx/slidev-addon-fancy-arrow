...
<img v-click="1" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Markdown-mark.svg/250px-Markdown-mark.svg.png" w-30 data-id="markdown-mark" absolute top-30 right-25 v-motion :initial="{x: +80, y: -80}" :enter="{x: 0, y: 0}"/>
<img v-click="1" src="https://github.com/vuejs/art/blob/master/logo.png?raw=true" w-30 data-id="vue-mark" absolute bottom-10 right-120 v-motion :initial="{x: +30, y: +80}" :enter="{x: 0, y: 0}"/>
