...
- [#385](https://github.com/whitphx/slidev-addon-fancy-arrow/pull/385) [`7c240b8`](https://github.com/whitphx/slidev-addon-fancy-arrow/commit/7c240b8f52ab6aac26d963101a9d282eba36fa9f) Thanks [@whitphx](https://github.com/whitphx)! - Accept plain CSS color values such as `var(--my-color)`, `#ff8800`, and `rgb(255 136 0)` in the `color` prop. Previously the prop only became a `text-*` UnoCSS class, which took effect only for the tokens UnoCSS happened to generate a utility for. UnoCSS tokens keep rendering exactly as before.
...
- [#250](https://github.com/whitphx/slidev-addon-fancy-arrow/pull/250) [`1671348`](https://github.com/whitphx/slidev-addon-fancy-arrow/commit/1671348569fa0cd45a0d50e13c9ab173cc8aaffe) Thanks [@whitphx](https://github.com/whitphx)! - Fix README.md about animation
...
- [#197](https://github.com/whitphx/slidev-addon-fancy-arrow/pull/197) [`6b75f0c`](https://github.com/whitphx/slidev-addon-fancy-arrow/commit/6b75f0c7abec185bb3d6f4c91351d7c2d21f3547) Thanks [@whitphx](https://github.com/whitphx)! - Fix the shorthand parser to ignore white spaces in the location part

## 0.13.6

### Patch Changes

- [`0aa24a7`](https://github.com/whitphx/slidev-addon-fancy-arrow/commit/0aa24a7cfd9bc2a4ba3ba90fc63c5cdade6f5e65) Thanks [@whitphx](https://github.com/whitphx)! - Fix NPM publishing workflow

## 0.13.5

### Patch Changes

- [`7ce80bf`](https://github.com/whitphx/slidev-addon-fancy-arrow/commit/7ce80bff7556230f7297aee260f6196c8e9e3443) Thanks [@whitphx](https://github.com/whitphx)! - Fix NPM trusted publishing workflow
...
- [#150](https://github.com/whitphx/slidev-addon-fancy-arrow/pull/150) [`583880b`](https://github.com/whitphx/slidev-addon-fancy-arrow/commit/583880b06a4b21d9fce706c9a22e22b372b9a383) Thanks [@whitphx](https://github.com/whitphx)! - Fix internal implementation
